...
//                    exit;
                    if ( !$this->checkRule($rule,array('in','1,2')) ){
                        $arr = array('deletedata','editsection','delsection','regainsection','editdrugs','deldrugs','regaindrugs','delcomment','regaincomment','orderinfo','refundorder','orderrefund','editunit','proorder');
