...
class wechatpayPlugs extends Plugs{
    ...
    Public function install(){
        ...
        $sql = <<<sql
CREATE TABLE IF NOT EXISTS `t_wechat_pay` (
...
sql;
        Db::execute($sql);
        //写入钩子
        Db::execute("INSERT INTO `t_hooks` VALUES ('', 'wechatpay', '微信支付钩子', '1', ".time().", '')");
        return true;
    }
    ...
    Public function uninstall(){
        ...
        //移除钩子
        Db::execute("delete from `t_hooks` where name='wechatpay'");
        return true;
    }
    ...
    Public function wechatpay(){
        ...
        $sign = $wechatpay->getSign(Session::get('wechat_appid'), Session::get('wechat_appsecret'), url('','',true,true));
