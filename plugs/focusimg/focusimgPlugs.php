...
sql;
            Db::execute($sql);
            //写入轮播钩子
            Db::execute("INSERT INTO `t_hooks` VALUES ('', 'focusMap', '轮播钩子', '1', ".time().", '')");
            return true;
        }
        ...
        public function uninstall(){
            ...
            Db::execute('DROP TABLE IF EXISTS t_focus_img');
            //移除钩子
            Db::execute("delete from `t_hooks` where name='focusMap'");
            return true;
        }
