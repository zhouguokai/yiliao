    	...
    	function cPlugin(o){
    		var sjObj=o;
		        ...
		        sjObj.defaults={
		            ...
		            df_box:function(){return $("</div><div class='df-box "+(sjObj.opt.alwaysShow?"alwaysShow":"")+"' style='line-height:"+sjObj.opt.height+"px;padding:16px;'></div>")},
		            df_main:function(){return $("<div class='df-main'>")},
		            df_btn:function(){
		                if(sjObj.opt.alwaysShow){
		                    return
		                }
		                return $("<div class='df-btn'><div class='df-ok'>"+sjObj.opt.okText+"</div></div>");//<div class='df-no'>"+sjObj.opt.cancelText+"</div>
		            },
		            ...
		            strEnd:function(){
		                var df=this;
		                return "</ul><div class='G-bg'><div class='G-top' style='height:"+(df.height*2)+"px'></div><div class='G-mid active' style='height:"+df.height+"px'></div><div class='G-btm' style='height:"+(df.height*2)+"px'></div></div></div>"
		            },
		            //数字小于10 就在字前面+一个0
		            fillZero:function(x){
		                if(x<10){
